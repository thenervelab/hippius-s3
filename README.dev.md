...
2. Pod logs hold ~15 minutes: `kubectl -n hippius-s3-prod logs <api-local-xxx> --since=15m | grep <ray_id>`. Older evidence lives in Tempo and Prometheus; see the runbook for the current state of the log store.
