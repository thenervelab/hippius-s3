\restrict Ka1wEtImHb0lt05zM9keyamlySUzt0Z78V23y2Km3Lb8TrGslxKVtdTmlGP1r2k
...
--
-- Name: update_bucket_acls_updated_at(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_bucket_acls_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
--
-- Name: update_object_acls_updated_at(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_object_acls_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
--
-- Name: bucket_acls bucket_acls_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER bucket_acls_updated_at BEFORE UPDATE ON public.bucket_acls FOR EACH ROW EXECUTE FUNCTION public.update_bucket_acls_updated_at();


--
-- Name: object_acls object_acls_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER object_acls_updated_at BEFORE UPDATE ON public.object_acls FOR EACH ROW EXECUTE FUNCTION public.update_object_acls_updated_at();
...
\unrestrict Ka1wEtImHb0lt05zM9keyamlySUzt0Z78V23y2Km3Lb8TrGslxKVtdTmlGP1r2k
