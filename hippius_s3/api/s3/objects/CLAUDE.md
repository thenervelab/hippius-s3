...
| ID | Time | T | Title | Read |
|----|------|---|-------|------|
| #6970 | 2:11 PM | 🔴 | Fixed parameter naming in handle_streaming_copy calls from db=pool to pool=pool | ~385 |
| #6960 | 2:03 PM | 🔴 | Additional handlers migrated to pool-based pattern in follow-up commit | ~680 |
| #6956 | 1:34 PM | 🔄 | Migrated handle_copy_object to pool-based parameter from legacy db connection | ~484 |
| #6955 | " | 🔴 | Fixed copy endpoint to pass pool instead of scoped connection | ~465 |
| #6954 | 1:33 PM | 🔄 | Added asyncpg import to copy_object_endpoint for pool type hints | ~308 |
| #6953 | 1:31 PM | 🔵 | PR #150 security review identifies P1 transaction atomicity bug in append_stream | ~859 |
| #6952 | " | 🔵 | PR review identifies partial migration in bucket router endpoints | ~508 |
| #6937 | 12:59 PM | 🔄 | Updated PUT object endpoint to instantiate ObjectWriter with pool | ~362 |
